...
const readOnlyOrderDeliveredItem = (props) => (
    <div className="flex flex-col mb-6 rounded-lg bg-white shadow-xl border-l-8 border-green-500">
...
export default readOnlyOrderDeliveredItem;